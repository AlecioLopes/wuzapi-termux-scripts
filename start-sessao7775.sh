...
WUZAPI_PORT=8081
EOF
    echo "✅ Arquivo .env criado automaticamente para sessão 7775"
}

# Clonar se não existir
if [ ! -d ".git" ]; then
    echo "📥 Clonando repositório para Sessão 7775..." | tee -a "$LOG_FILE"
